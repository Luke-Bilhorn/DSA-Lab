 ...
 * June 18, 2015
 */
public class DepthFirstTraversalRecursive implements Traversal {
    /**
     ...
     */
    public int[] finishingTimes() { return finishingTimes; }
    ...
    public int[] traverse(Graph g, int start, PerformOnVertex op) {
       ...
       finishingTimes = new int[g.numVertices()];
       for (int i = 0; i < g.numVertices(); i++)
           parents[i] = discoveryTimes[i] = finishingTimes[i] = -1;

       time = 0;
       internalR(g, start, op, parents);
       return parents;
   }
    ...
    * underway.
    */
   private void internalR(Graph g, int v, PerformOnVertex op, int[] parents) {
